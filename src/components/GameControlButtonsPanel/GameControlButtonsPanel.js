...
function GameControlButtonsPanel({
  ...
  function submitCandidateGuess() {
    ...
    if (isGuessRepeated({ submittedGuesses, guessCandidate })) {
      toast({
        label: "Notification",
        title: "Nicht so stürmisch!",
        description: "Du hast diese Kombination bereits geraten.",
      });
    ...
    if (isCorrect) {
      ...
      if (isGuessOneAway) {
        toast({
          ...
          title: "Fast da!",
          description:
            "Drei deiner vier geratenen Worte gehören zusammen.",
        });
      }
    }
  }
  ...
  return (
    <div className="grid grid-cols-3 gap-4">
      ...
      >
        ...
        <p className="select-none">Durchmischen</p>
      </Button>
      <Button
      ...
      >
        ...
        <p className="select-none">Alle Abwählen</p>
      </Button>
      <Button
        variant="submit"
      ...
      >
        ...
        <p className="select-none">Einloggen</p>
      </Button>
    </div>
  );
}
